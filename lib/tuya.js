...
function getCoverStateEnums(manufacturerName) {
    if (manufacturerName in coverStateOverride) {
        ...
        return {close: 2, open: 0, stop: 1, continue: 4}; // defaults
    }
}
...
const dataPoints = {
    ...
    trsMotionSpeed: 115,
    trsRadarID: 111, //CongNT16 add
    trsHWVersion: 109, //CongNT16 add
    trsSWVersion: 110, //CongNT16 add
    trsResetFlag: 101, //CongNT16 add
    trsRadarCheckEnd: 107, //CongNT16 add
    trsRadarChechStart: 108, //CongNT166 add
    trsFallDownStatus: 116, //CongNT166 add
    trsFallSensitivity: 118, //CongNT16 add
    trsTumbleAlarmTime: 106, //CongNT16 add
    trsTumbleSwitch: 105, //CongNT16 add
    ...
    // CongNT16: add Tuya Curtain Robot Mortor
    tcrControl: 1,
    tcrCurtainPositionSetting: 2, //AM02PercentControl: 2,
    tcrCurrentCurtainPosition: 3, //AM02PercentState: 3,
    tcrMode: 4,
    tcrMotorDirection: 5,
    tcrWorkState: 7,
    //AM02CountdownLeft: 9,
    ...
    tcrSituationSet: 11,
    tcrFault: 12,
    tcrBatteryPercentage: 13,
    tcrBorder: 16,
    tcrBestPosition: 19,
    tcrClickControl: 20, //AM02MotorWorkingMode
    //AM02AddRemoter: 101,
...
// CongNT16: Add Curtain robot motor Datapoint
    /*tcrControl: 1,
    tcrCurtainPositionSetting: 2, //AM02PercentControl: 2,
    tcrCurrentCurtainPosition: 3, //AM02PercentState: 3,
    tcrMode: 4,
...
const tuyaCurtainRobot = {
    ...
    tcrBorder: {
        0: 'upper_limit_setting',
        1: 'lower_limit_setting',
        2: 'remove_upper_limit_setting',
        3: 'remove_lower_limit_setting',
        4: 'remove_all_setting',
    },
    tcrSituationSet: {
        0: 'fully_open',
        1: 'fully_close',
